export const factionData = {
  units: [
    /* characters */
    {
      ...
      weapons: [{ name: 'Storm bolter' }, { name: 'Nemesis force weapon' }],
      unitOptions: {
        weapons: [{ name: ['Incinerator', 'Psilencer', 'Psycannon'], replaces: 'Storm bolter' }],
      },
    },
    {
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Character', 'Infantry', 'Psyker', 'Grenades', 'Imperium', 'Brotherhood Champion'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Nemesis force weapon' }],
    },
    {
      name: 'Brotherhood Chaplain',
      modelCount: 1,
      tags: ['Brotherhood Chaplain', 'Terminator', 'Psyker', 'Imperium', 'Infantry', 'Character'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Crozius arcanum' }],
    },
    {
      name: 'Brotherhood Librarian',
      modelCount: 1,
      tags: ['Brotherhood Librarian', 'Imperium', 'Terminator', 'Infantry', 'Character', 'Psyker'],
      weapons: [{ name: 'Nemesis force weapon' }, { name: 'Vortex of Doom' }],
      unitOptions: {
        weapons: [{ name: ['Combi-weapon', 'Storm bolter'], max: 1 }],
      },
    },
    {
      name: 'Brotherhood Techmarine',
      modelCount: 1,
      tags: ['Character', 'Infantry', 'Psyker', 'Grenades', 'Imperium', 'Brotherhood Techmarine'],
      weapons: [
        { name: 'Forge bolter' },
        { name: 'Grav-pistol' },
    ...
    },
    {
      ...
      unitOptions: {
        weapons: [
          ...
          {
            name: ['Gatling psilencer', 'Heavy incinerator', 'Heavy psycannon', 'Sublimator'],
            max: 2,
          },
    ...
    },
    {
      ...
      weapons: [{ name: 'Searing Purity' }, { name: 'Storm bolter' }, { name: 'Malleus Argyrum' }],
    },
    {
    ...
    {
      name: 'Strike Squad',
      tags: ['Strike Squad', 'Psyker', 'Imperium', 'Grenades', 'Battleline', 'Infantry'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Nemesis force weapon' }],
      unitOptions: {
        unitSize: [5, 10],
        weapons: [
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Dedicated Transport', 'Vehicle', 'Transport', 'Smoke', 'Imperium', 'Relic Razorback'],
    },
    {
      name: 'Razorback',
      modelCount: 1,
      tags: ['Razorback', 'Dedicated Transport', 'Vehicle', 'Transport', 'Smoke', 'Imperium'],
      weapons: [{ name: 'Twin heavy bolter' }, { name: 'Armoured tracks' }],
      unitOptions: {
        weapons: [
    ...
    },
    {
      name: 'Rhino',
      modelCount: 1,
      tags: ['Rhino', 'Transport', 'Vehicle', 'Dedicated Transport', 'Imperium', 'Smoke', 'Rhino'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Armoured tracks' }],
      unitOptions: {
        weapons: [
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Dreadnought', 'Walker', 'Vehicle', 'Psyker', 'Smoke', 'Imperium'],
    },
    {
    ...
    },
    {
      ...
      tags: ['Infantry', 'Grenades', 'Imperium', 'Fly', 'Psyker', 'Interceptor Squad'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Nemesis force weapon' }],
      unitOptions: {
        unitSize: [5, 10],
        weapons: [
    ...
    },
    {
      name: 'Land Raider',
      modelCount: 1,
      tags: ['Vehicle', 'Smoke', 'Transport', 'Imperium', 'Land Raider'],
      weapons: [
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Vehicle', 'Transport', 'Smoke', 'Imperium', 'Grenades', 'Land Raider Crusader'],
      weapons: [
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Land Raider Redeemer', 'Grenades', 'Imperium', 'Vehicle', 'Transport', 'Smoke'],
      weapons: [
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Nemesis Dreadknight', 'Vehicle', 'Walker', 'Psyker', 'Imperium'],
      weapons: [{ name: 'Dreadfists' }],
      unitOptions: {
        weapons: [
    ...
    {
      name: 'Paladin Squad',
      tags: ['Infantry', 'Grenades', 'Imperium', 'Psyker', 'Terminator', 'Paladin Squad'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Nemesis force weapon' }],
      unitOptions: {
        unitSize: [4, 5, 8, 10],
        weapons: [
    ...
    },
    {
      ...
      tags: ['Purgation Squad', 'Psyker', 'Imperium', 'Grenades', 'Infantry'],
      weapons: [{ name: 'Storm bolter' }, { name: 'Nemesis force weapon' }],
      unitOptions: {
        unitSize: [5, 10],
        weapons: [
          ...
          {
            name: ['Incinerator', 'Psilencer', 'Psycannon'],
    ...
    {
      name: 'Purifier Squad',
      tags: ['Purifier Squad', 'Psyker', 'Imperium', 'Grenades', 'Infantry'],
      weapons: [
        { name: 'Purifying Flame' },
        { name: 'Storm bolter' },
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Stormhawk Interceptor', 'Vehicle', 'Aircraft', 'Fly', 'Smoke', 'Imperium'],
      weapons: [
        { name: 'Las-talon' },
      ...
      unitOptions: {
        weapons: [
          ...
          {
            name: ['Twin heavy bolter', 'Typhoon missle launcher'],
            replaces: 'Skyhammer missile launcher',
          },
        ],
      },
    },
    {
      ...
      modelCount: 1,
      tags: ['Stormraven Gunship', 'Aircraft', 'Vehicle', 'Transport', 'Fly', 'Imperium'],
      weapons: [
    ...
    },
    {
      ...
      modelCount: 1,
      tags: ['Stormtalon Gunship', 'Aircraft', 'Vehicle', 'Fly', 'Imperium'],
      weapons: [
        { name: 'Skyhammer missile launcher' },
        { name: 'Twin assault cannon' },
        { name: 'Armoured hull' },
      ...
      unitOptions: {
        weapons: [
          {
            name: ['Twin heavy bolter', 'Twin lascannon', 'Typhoon missle launcher'],
            replaces: 'Skyhammer missile launcher',
          },
        ],
      },
