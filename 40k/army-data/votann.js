export const factionData = {
  units: [
    /* characters */
    {
      ...
      weapons: [{ name: 'Transmatter inverter' }, { name: 'Close combat weapon' }],
    },
    {
      name: 'Brôkhyr Iron-master',
      tags: ['Character', 'Infantry', 'Brôkhyr', 'Brôkhyr Iron-master'],
      weapons: [{ name: 'Graviton rifle' }, { name: 'Graviton hammer' }],
    },
    {
      name: 'Buri Aegnirssen',
      tags: ['Character', 'Infantry', 'Epic Hero'],
      weapons: [{ name: 'Autoch-pattern bolt pistol' }, { name: 'Bane' }],
    },
    {
      ...
      wargear: [{ name: 'Weavefield crest', count: 0 }],
      unitOptions: {
        weapons: [{ name: 'Darkstar axe', replaces: 'Mass hammer' }],
        wargear: [{ name: 'Teleport crest', replaces: 'Weavefield crest' }],
      },
    },
    {
      name: 'Grimnyr',
      tags: ['Character', 'Infantry', 'Psyker', 'Grimnyr'],
      weapons: [{ name: 'Ancestral Wrath' }, { name: 'Ancestral Ward Stave' }],
    },
    {
      name: 'Kâhl',
      tags: ['Character', 'Infantry', 'Kâhl'],
      weapons: [{ name: 'Autoch-pattern combi-bolter' }, { name: 'Forgewrought plasma axe' }],
      wargear: [{ name: 'Rampart crest' }],
      unitOptions: {
        weapons: [
          { name: 'Volkanite disintegrator', replaces: 'Autoch-pattern combi-bolter' },
          { name: 'Mass gauntlet', replaces: 'Forgewrought plasma axe' },
        ],
        wargear: [{ name: 'Teleport crest', replaces: 'Rampart crest' }],
      },
    },
    {
      name: 'Memnyr Strategist',
      tags: ['Character', 'Infantry', 'Memnyr Strategist'],
      weapons: [{ name: 'Autoch-pattern bolt pistol' }, { name: 'Close combat weapon' }],
    },
    {
      name: 'Ûthar the Destined',
      tags: ['Character', 'Infantry', 'Kâhl', 'Epic Hero'],
      weapons: [{ name: 'Volkanite disintegrator' }, { name: 'Blade of the Ancestors' }],
      wargear: [{ name: 'Rampart crest' }],
    },
    /* battleline */
    {
      ...
      wargear: [{ name: 'Weavefield crest', count: 1 }],
      unitOptions: {
        weapons: [
          {
            name: ['Theyn’s ion blaster', 'Theyn’s pistol'],
            replaces: 'Theyn’s autoch-pattern bolter',
            max: 1,
          },
          ...
          { name: 'Plasma knife', replaces: ['Autoch-pattern bolter', 'Ion blaster'], max: 2 },
          {
            ...
            replaces: ['Autoch-pattern bolter', 'Ion blaster'],
            max: 2,
            selectionType: 'anyNoDuplicates',
          },
        ],
      },
    },
    ...
    },
    {
      ...
      unitOptions: {
        weapons: [
          {
            name: ['L7 missile launcher & 1 Sagitaur missile launcher', 'MATR autocannon'],
            replaces: 'HYLas beam cannon',
          },
        ],
      },
    },

    {
      ...
      unitOptions: {
        ...
        weapons: [
          {
            name: ['Graviton blast cannon', 'SP conversion beamer'],
    ...
    },
    {
      ...
      weapons: [{ name: 'Heavy plasma axe', count: 0 }],
      unitOptions: {
        unitSize: [5, 10],
        weapons: [
          {
    ...
    },
    {
      ...
      unitOptions: {
        ...
        weapons: [
          ...
          {
            name: 'Hesyr’s Graviton hammer',
            replaces: ['Concussion gauntlet', 'Plasma blade gauntlet'],
            max: 1,
          },
        ],
        wargear: [{ name: 'Teleport crest', replaces: 'Weavefield crest' }],
    ...
    },
    {
      ...
      wargear: [{ name: 'Pan spectral scanner' }],
    },
    {
    ...
    },
    {
      ...
      weapons: [{ name: 'Bolt shotgun' }, { name: 'Close combat weapon' }],
      unitOptions: {
        weapons: [
          { name: 'Bolt revolver & Plasma knife', replaces: 'Bolt shotgun' },
          {
            name: 'Magna-coil rifle',
            replaces: ['Bolt revolver & Plasma knife', 'Bolt shotgun'],
            max: 1,
          },
          {
            name: 'APM launcher',
    ...
    },
    {
      ...
      weapons: [{ name: 'Heavy volkanite disintegrator & Plasma knife' }],
      wargear: [{ name: 'Preymark crest' }],
      unitOptions: {
        unitSize: [3, 6],
        weapons: [
          // (these upgrades are paired, if you take one you have to take the other too; there's probably a better way to encode this)
          {
            name: 'Steeljack Theyn’s autoch-pattern bolter & Plasma sword',
            replaces: 'Heavy volkanite disintegrator & Plasma knife',
            max: 1,
          },
        ],
      },
    },
    {
      ...
      weapons: [{ name: 'Autoch-pattern bolter' }, { name: 'Plasma sword' }],
      wargear: [{ name: 'Preymark crest' }],
      unitOptions: {
        unitSize: [3, 6],
        weapons: [{ name: 'Concussion gauntlet', replaces: 'Plasma sword' }],
      },
    },
    {
      ...
      unitOptions: {
        unitSize: [1, 2],
        weapons: [{ name: 'HYLas rotary cannon', replaces: 'Magna-rail cannon' }],
      },
    },
  ],
  detachments: [
    ...
    },
    {
      ...
      unitModifications: [{ type: 'addTag', target: 'Cthonian Beserks', value: 'Battleline' }],
    },
    {
      name: 'Hearthband',
      enhancements: [
