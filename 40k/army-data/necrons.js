export const factionData = {
  "units": [
        ...
        { name: "Lokhust Lord", tags: ["Character", "Mounted", "Fly", "Destroyer Cult", "Lokhust Lord"],
          ...
          unitOptions: {
            weapons: [
              { name: "Lord's blade", replaces: "Staff of light" },
            ],
            wargear: [
              { name: ["Nanoscarab amulet", "Resurrection orb"], max: 1 }
            ]
          },
         },
        { name: "Nekrosor Ammentar", tags: ["Character", "Epic Hero", "Infantry", "Destroyer Cult", "Nekrosor Ammentar"],
          weapons: [
        ...
        { name: "Plasmancer", tags: ["Character", "Infantry", "Cryptek", "Plasmancer"], weapons: [ { name: "Plasmic lance" } ] },
        { name: "Psychomancer", tags: ["Character", "Infantry", "Cryptek", "Psychomancer"], weapons: [ { name: "Abyssal lance" } ] },
        ...
        /* battleline */
        { name: "Immortals", modelCount: [5, 10], tags: ["Battleline", "Infantry", "Immortals"],
          weapons: [
            { name: "Gauss blaster"},
            { name: "Close combat weapon"}
          ],
          unitOptions: {
            unitSize: [5, 10],
            weapons: [
              { name: "Tesla carbine", replaces: "Gauss blaster" }
            ]
          }
        },
        { name: "Necron Warriors", modelCount: [10, 20], tags: ["Battleline", "Infantry", "Necron Warriors"],
          weapons: [
            { name: "Gauss flayer"},
            { name: "Close combat weapon"}
          ],
          unitOptions: {
            unitSize: [10, 20],
            weapons: [
              { name: "Gauss reaper", replaces: "Gauss flayer" }
            ]
          }
        },

        /* dedicated transports */
        { name: "Ghost Ark", tags: ["Vehicle", "Fly", "Transport", "Dedicated Transport", "Ghost Ark"] },

        /* Fortifications */
        { name: "Convergence Of Dominion", tags: ["Fortification", "Vehicle", "Convergence Of Dominion"], unitOptions: { unitSize: [1, 2, 3] } },

        { name: "Annihilation Barge", tags: ["Vehicle", "Fly", "Annihilation Barge"],
          weapons: [
            { name: "Gauss cannon"},
        ...
        { name: "Canoptek Macrocytes", tags: ["Beasts", "Fly", "Canoptek", "Macrocytes"], modelCount: 5,
          ...
          unitOptions: {
            weapons: [
              ...
              { name: "Atomiser beam and nanoscarab projector", replaces: ["Gauss scalpel", "Tesla caster"], max: 1 },
        ...
        { name: "Canoptek Spyders", tags: ["Vehicle", "Fly", "Canoptek", "Spyders"],
          weapons: [
          ...
          unitOptions: {
            unitSize: [1, 2],
            weapons: [
              { name: "2x Particle beamers", max: [1, 2] },
            ],
            wargear: [
        ...
        { name: "Canoptek Tomb Crawlers", tags: ["Beasts", "Canoptek", "Tomb Crawlers"], modelCount: 2,
          ...
          unitOptions: {
            weapons: [
              { name: "Transdimensional isolator", replaces: "Twin gauss reaper", max: 1 }
            ]
          }
        },
        { name: "Canoptek Wraiths", tags: ["Beasts", "Fly", "Canoptek", "Wraiths"],
          weapons: [
            { name: "Vicious claws"}
          ],
          unitOptions: {
            unitSize: [3, 6],
            weapons: [
              { name: ["Particle caster", "Transdimensional beamer"], max: "[unitSize]", selectionType: "any" },
        ...
        { name: "Lokhust Heavy Destroyers", tags: ["Mounted", "Fly", "Destroyer Cult", "Lokhust Heavy Destroyers"], 
          weapons: [
          ...
          unitOptions: {
            unitSize: [1, 2, 3],
            weapons: [
              { name: "Enmitic exterminator", replaces: "Gauss destructor" }
            ]
          }
        },
        { name: "Lychguard", tags: ["Infantry", "Lychguard"],
          weapons: [
            { name: "Warscythe" }
          ],
          unitOptions: {
            unitSize: [5, 10],
            weapons: [
              { name: "Hyperphase sword", replaces: "Warscythe" }
            ],
            wargear: [
              { name: "Dispersion shield", excludes: ["Warscythe"] }
            ]
          }
        },
        { name: "Monolith", tags: ["Vehicle", "Titanic", "Fly", "Towering", "Monolith"],
          ...
          unitOptions: {
            weapons: [
              { name: "Death rays", replaces: "Gauss flux arcs" }
            ]
          }
         },
        { name: "Night Scythe", tags: ["Vehicle", "Aircraft", "Fly", "Transport", "Night Scythe"] },
        { name: "Obelisk", tags: ["Vehicle", "Titanic", "Fly", "Towering", "Obelisk"] },
        { name: "Ophydian Destroyers", tags: ["Infantry", "Destroyer Cult", "Ophydian Destroyers"],
          unitOptions: {
            unitSize: [3, 6],
            wargear: [
              { name: "Plasmacyte", max: 1, per: 3 }
            ]
          }
        },
        { name: "Skorpekh Destroyers", tags: ["Infantry", "Destroyer Cult", "Skorpekh Destroyers"],
          unitOptions: {
            unitSize: [3, 6],
            wargear: [
              { name: "Plasmacyte", max: 1, per: 3 }
        ...
        { name: "Tomb Blades", tags: ["Mounted", "Fly", "Tomb Blades"],
          weapons: [
        ...
        { name: "Triarch Praetorians", tags: ["Infantry", "Fly", "Triarch", "Praetorians"],
          weapons: [
          ...
          unitOptions: {
            unitSize: [5, 10],
            weapons: [
              { name: ["Particle caster and Voidblade"], replaces: "Rod of covenant" }
            ]
          }
        },
