...
const CacheConfig = {
  ...
  getCoreResources() {
    return [
      ...
      '/40k/index.html',
      '/40k/40k.js',
      '/40k/army-data-loader.js',
      '/40k/army-data/factions.js',
      '/40k/army-data/points.js',
      '/40k/army-data/aeldari.js',
      '/40k/army-data/astra.js',
      '/40k/army-data/blackTemplars.js',
      '/40k/army-data/bloodAngels.js',
      '/40k/army-data/chaosKnights.js',
      '/40k/army-data/chaosMarines.js',
      '/40k/army-data/custodes.js',
      '/40k/army-data/daemons.js',
      '/40k/army-data/darkAngels.js',
      '/40k/army-data/deathGuard.js',
      '/40k/army-data/deathwatch.js',
      '/40k/army-data/drukhari.js',
      '/40k/army-data/emperorsChildren.js',
      '/40k/army-data/greyKnights.js',
      '/40k/army-data/gsc.js',
      '/40k/army-data/imperialAgents.js',
      '/40k/army-data/imperialKnights.js',
      '/40k/army-data/mechanicus.js',
      '/40k/army-data/necrons.js',
      '/40k/army-data/orks.js',
      '/40k/army-data/sisters.js',
      '/40k/army-data/spaceMarines.js',
      '/40k/army-data/spaceWolves.js',
      '/40k/army-data/tau.js',
      '/40k/army-data/thousandSons.js',
      '/40k/army-data/tyranids.js',
      '/40k/army-data/votann.js',
      '/40k/army-data/worldEaters.js',
      '/40k/list/index.html',
      '/40k/list/40k-list.js',
      '/40k/metadata/index.html',
      '/40k/metadata/40k-metadata.js',
      '/40k/play/index.html',
      '/40k/play/40k-play.js',
      '/aos/index.html',
      '/aos/aos.js',
      ...
      '/components/CategorySection/index.js',
      '/components/CategorySection/UnitRow.js',
      '/components/CategorySection/helpers.js',
      '/components/option-renderers/ExclusionManager.js',
      '/components/option-renderers/FormParser.js',
      '/components/option-renderers/OptionRendererFactory.js',
      '/components/option-renderers/OptionRenderers.js',
      '/components/option-renderers/OptionUtils.js',
      ...
      '/src/domUtils.js',
      '/src/battlescribe-parser.js',
      '/src/option-summaries.js',
      '/40k/army-data/factions.js',
      '/40k/army-data/points.js',
      '/40k/army-data/aeldari.js',
      '/40k/army-data/astra.js',
