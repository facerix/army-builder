...
import {
  normalizeSelectedToArray,
  formatReplacedItemsLabel,
  optionFieldsetName,
} from './OptionUtils.js';
 ...
 */
export const renderReplacesWithoutMax = (
  option,
  currentOption,
  fieldsetName,
  isDisabled = false
    ...
    ...upgradeOptions.map(upgradeName => {
      return h('div', { className: 'option-value' }, [
        h('input', {
          ...
          name: fieldsetName,
          value: upgradeName,
          checked: currentOption?.selected === upgradeName,
          disabled: isDisabled,
        }),
 ...
 */
export const renderArrayMaxOneWithReplaces = (
  option,
  currentOption,
  fieldsetName,
  isDisabled = false
 ...
 */
export const renderArrayMaxOneWithoutReplaces = (
  option,
  currentOption,
  fieldsetName,
  isDisabled = false
...
export const renderArrayMaxMulti = (option, currentOption, fieldsetName, isDisabled = false) => {
  ...
  return h('div', { className: 'option-item option-item-multi' }, [
    h('div', { className: 'option-header' }, [
      ...
      h('span', {
        className: 'option-counter',
        innerText: `${selectedCount} / ${option.max} selected`,
      }),
    ]),
 ...
 */
export const renderSingleStringWithMax = (
  option,
  currentOption,
  fieldsetName,
  isDisabled = false,
 ...
 */
export const renderSelectionTypeAll = (
  option,
  currentOption,
  fieldsetName,
  effectiveMax,
  ...
  return h('div', { className: 'option-item' }, [
    h('div', { className: 'option-value' }, [
      h('input', {
        ...
        name: fieldsetName,
        value: 'off',
        checked: !selectedValue || selectedValue === 'off',
        disabled: isDisabled,
      }),
    ...
    ...upgradeOptions.map(upgradeName => {
      return h('div', { className: 'option-value' }, [
        h('input', {
          ...
          name: fieldsetName,
          value: upgradeName,
          checked: selectedValue === upgradeName,
          disabled: isDisabled,
        }),
        h('label', { innerText: upgradeName, className: 'option-value' }),
      ]);
 ...
 */
export const renderSelectionTypeAny = (
  option,
  currentOption,
  fieldsetName,
  effectiveMax,
  ...
  return h('div', { className: 'option-item option-item-multi' }, [
    h('div', { className: 'option-header' }, [
      ...
      h('span', {
        className: 'option-counter',
        innerText: `${totalSelected} / ${effectiveMax} selected`,
      }),
    ]),
    h('div', { className: 'option-checkboxes' }, [
 ...
 */
export const renderSelectionTypeAnyNoDuplicates = (
  option,
  currentOption,
  fieldsetName,
  effectiveMax,
  ...
  return h('div', { className: 'option-item option-item-multi' }, [
    h('div', { className: 'option-header' }, [
      ...
      h('span', {
        className: 'option-counter',
        innerText: `${selectedCount} / ${effectiveMax} selected`,
      }),
    ]),
    h('div', { className: 'option-checkboxes' }, [
      ...upgradeOptions.map(upgradeName => {
 ...
 */
export const renderSingleStringWithPer = (
  option,
  currentOption,
  fieldsetName,
  effectiveMax,
